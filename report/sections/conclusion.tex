...
\begin{enumerate}
  ...
  \item \textbf{The controlled PLAID operating points are dominated at this
    ...
    0.6750 (SciFact) and 0.5975 (NFCorpus), while taking 24.65--35.86 times the
  ...
  \item \textbf{Exact-safe BOND pruning on raw ColBERT dimensions is a clear
    ...
    94--95\% of the exhaustive component products. Every SciFact prune and
  ...
  \item \textbf{Dimension ordering helps the bound, not the kernel.} An
    ...
    remain 8.38--8.51 times slower than their same-run exhaustive reference;
