...
def run_arm(
    ...
    return {
        ...
        "strict_top_k_set_equal": record.strict_top_k_set_equal,
        "boundary_tie_equivalent": record.boundary_tie_equivalent,
        "agreement_failure_codes": record.agreement_failure_codes,
