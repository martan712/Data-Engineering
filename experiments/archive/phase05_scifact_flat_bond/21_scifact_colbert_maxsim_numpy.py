"""Exact NumPy ColBERT MaxSim reference for the SciFact subset."""
...
OUTPUT_PATH = RESULTS_DIR / "scifact_colbert_maxsim_numpy.json"
...
def main() -> None:
    ...
    print("SciFact exact ColBERT MaxSim")
