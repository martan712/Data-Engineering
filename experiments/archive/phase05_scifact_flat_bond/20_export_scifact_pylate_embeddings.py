"""Export PyLate / ColBERT embeddings for the SciFact benchmark subset."""
...
OUTPUT_DIR = PROJECT_ROOT / "artifacts" / "scifact_benchmark_embeddings"
...
def main() -> None:
    ...
    if not documents or not queries:
        raise SystemExit("SciFact subset is empty. Run 19_prepare_scifact_benchmark.py first.")
