...
BUILD_OUTPUT="${BUILD_DIR}/_bond_maxsim${EXT_SUFFIX}"
OUTPUT_PATH="${OUTPUT_DIR}/_bond_maxsim${EXT_SUFFIX}"
...
cd "${REPO_ROOT}"
"${PYTHON}" -c \
    'from experiments.kernels import _bond_maxsim; print(f"built {_bond_maxsim.__file__} (OpenMP={_bond_maxsim.openmp_enabled})")'
